...
Furthermore, G-separation allows for the calculation of both ATT and ATU by restricting the ATE estimation to the treated and the untreated respectively[@Wang]. 
...
# github link to our analysis project: https://github.com/aduarte56/AbortionLaws
