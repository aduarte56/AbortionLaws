...
which means that the causal effect of Law on MMR can be estimated. Conditioning on counfounders is still (statictically) desirable, as it will increase the precision of the effect estimate.
...
However, in observational studies, the causal effect is identified only when we control for all counfounders. If there is unobserved counfounding (Figure2b), the causal effect can't be identified as:

$$
MMR^{(1)}, MMR^{(0)} \indep Law \mid Female \ primary \ education, GDP, Unmeasured \ counfounders
$$ 
