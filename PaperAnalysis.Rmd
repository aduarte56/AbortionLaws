...
###G-separation
G-separation or G computation is a method that enables the unbiased estimation of marginal causal effects by using counterfactuals. It thus responds to the rupture of two of the main assumptions discussed above: the missingness of counterfactuals on observational data (because it is impossible to observe participants under both treatment and non-treatment) and heterogeneity of effects (). 
